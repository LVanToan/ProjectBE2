        ...
        <div class="container mw-1620 bg-white">
            ...
            <section class="blog-carousel container">
                <div class="d-flex align-items-center justify-content-between flex-wrap mb-3 pb-xl-2 mb-xl-4">
                    ...
                    <!-- <a class="btn-link btn-link_md default-underline text-uppercase fw-medium" href="#">See all categories</a> -->
                    <!-- route('locgia') -->
                </div>
            ...
            <section class="products-carousel container">
                <div class="d-flex align-items-center justify-content-between flex-wrap mb-3 pb-xl-2 mb-xl-4">
                    ...
                    <a class="btn-link btn-link_md default-underline text-uppercase fw-medium" href="#">See All Products</a>
                    <!-- route('locgia')  -->
                </div>
                                    ...
                                    <div class="tab-pane fade show {{ $loop->first ? 'active' : '' }}"
                                        ...
                                        <div id="product_{{ $category->category_id }}" class="position-relative">
                                            <div class="swiper-container js-swiper-slider"
                                                ...
                                                <div class="swiper-wrapper">
                                                    @if(
                                                        isset($productsByCategory[$category->category_id]) &&
                            ...
                            @foreach ($products as $product)
                                <div class="swiper-slide product-card product-card_style3">
                                    ...
                                    <div class="pc__info position-relative">
                                        ...
                                        <!-- route('product.show', Crypt::encryptString($product['product_id'])) -->
                                        <h6 class="pc__title mb-2"><a href="#">{{ $product['name'] }}</a>
                                        </h6>
                                        <div class="product-card__price d-flex align-items-center">
                                            <!-- route('product.show', Crypt::encryptString($product['product_id']))  -->
            ...
            <section class="blog-carousel container">
                <div class="d-flex align-items-center justify-content-between flex-wrap mb-3 pb-xl-2 mb-xl-4">
                    ...
                    <!-- route('blog.index') -->
                    <a class="btn-link btn-link_md default-underline text-uppercase fw-medium" href="#">Read all
                        articles</a>
                </div>
                            ...
                            @foreach($blogs as $blog)
                                <div class="swiper-slide blog-grid__item mb-4">
                                    <div class="blog-grid__item-image">
                                        ...
                                        <a href="#"><img loading="lazy" class="h-auto" src="{{ asset($blog->image_url) }}"
                                                width="450" height="300" alt=""></a>
                                    </div>
